 ...
 *
 * @param <T>
 * @version v1.0	2015.8.1
 * @version v1.1	2015.9.12	支持了简单的迭代器遍历
 * @version v1.2	2016.2.6	添加了新功能，获取元素时索引可以为负数
 * @version v1.3	2016.2.9	添加了替换的功能
 * @author congxiaoyao
 */
public class RoundList<T> implements Iterable<T> {
	...
	/**
	 * 将get方法在对应index上拿到的元素替换为t
	 * @param t
	 * @param index
     */
	public void replace(T t, int index) {
		objects[(tail + index) % size] = t;
	}
